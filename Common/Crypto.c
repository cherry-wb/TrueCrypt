...
#else
			aes_encrypt ((const unsigned char *)data, (unsigned char *)data, ks);
#endif
		break;

	case TWOFISH:		twofish_encrypt ((TwofishInstance *)ks, (const u4byte *)data, (u4byte *)data); break;
	case SERPENT:		serpent_encrypt ((const unsigned char *)data, (unsigned char *)data, (unsigned __int8 *)ks); break;
#ifndef TC_WINDOWS_BOOT
	case BLOWFISH:		BlowfishEncryptLE ((unsigned char *)data, (unsigned char *)data, (BF_KEY *)ks, 1); break;	// Deprecated/legacy
	case CAST:			Cast5Encrypt ((const byte *)data, (byte *)data, (CAST_KEY *)ks); break;			// Deprecated/legacy
...
void DecipherBlock(int cipher, void *data, void *ks)
{
	switch (cipher)
	{
	case SERPENT:	serpent_decrypt ((const unsigned __int8 *)data, (unsigned __int8 *)data, (unsigned char *)ks); break;
	case TWOFISH:	twofish_decrypt ((TwofishInstance *)ks, (const u4byte *)data, (u4byte *)data); break;
#ifndef TC_WINDOWS_BOOT
...
#endif
#if defined(_AES_H)
			aes_decrypt ((const unsigned char *)data, (unsigned char *)data, (const aes_decrypt_ctx *)(void *) ((char *) ks + sizeof(aes_encrypt_ctx)));
#else
	...
	case CAST:		Cast5Decrypt ((const byte *)data, (byte *)data, (CAST_KEY *)ks); break;			// Deprecated/legacy
