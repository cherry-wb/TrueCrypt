...
void CipherInit2(int cipher, void* key, void* ks, int key_len) 
{
	...
	case BLOWFISH:
		/* Deprecated/legacy */
		BlowfishSetKey ((BF_KEY *)ks, key_len, (unsigned char *)key); 
		break;
...
{
	unsigned char digest[WHIRLPOOL_DIGESTSIZE] = { 0 };

	hmac_whirlpool (hmac_whirlpool_test_key, 64, hmac_whirlpool_test_data, (int) strlen (hmac_whirlpool_test_data), (char *)digest, WHIRLPOOL_DIGESTSIZE);
